    ...
    it('GET /stores/:id/movies should return the movies page by page', async () => {
      ...
      for (const page of pages) {
        ...
        const expectedMovies = await execQuery(`
                ...
                m.overview, m.runtime, m.release_date AS "releaseDate", m.genres, m.countries_of_origin as "countriesOfOrigin", 
                m.language_code AS "language", m.movie_status AS "movieStatus", m.popularity, m.budget, m.revenue,
